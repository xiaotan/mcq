...
(function() {
    (function(e, t, n) {
        var r, i, s;
        s = "slidesjs";
        i = { width: 940, height: 528, start: 1, navigation: { active: !0, effect: "fade" }, pagination: { active: !0, effect: "fade" }, play: { active: !1, effect: "fade", interval: 5e3, auto: !1, swap: !0, pauseOnHover: !1, restartDelay: 2500 }, effect: { slide: { speed: 500 }, fade: { speed: 300, crossfade: !0 } }, callback: { loaded: function() {}, start: function() {}, complete: function() {} } };
        r = function() {
            function t(t, n) {
                this.element = t;
        ...
        r.prototype.init = function() {
            ...
            if (this.options.navigation.active) {
                o = e("<a>", { "class": "slidesjs-previous slidesjs-navigation", href: "#", title: "", text: "" }).appendTo(n);
                r = e("<a>", { "class": "slidesjs-next slidesjs-navigation", href: "#", title: "", text: "" }).appendTo(n)
            }
            ...
            if (this.options.pagination.active) {
                ...
                e.each(new Array(this.data.total), function(t) {
                    ...
                    r = e("<a>", { href: "#", "data-slidesjs-item": t, html: '' }).appendTo(n);
